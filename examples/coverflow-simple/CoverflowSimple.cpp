...
CoverflowSimple::CoverflowSimple( QQuickItem* parentItem )
...
void CoverflowSimple::addCover( QskGraphicLabel* cover )
{
...
QskGraphicLabel* CoverflowSimple::activeCover() const
{
...
void CoverflowSimple::setActiveCover( QskGraphicLabel* cover )
{
...
void CoverflowSimple::setMaxCoversOnEachSide( int num )
{
    m_maxCoversOnEachSide = num;
}

void CoverflowSimple::updateLayout()
{
...
void CoverflowSimple::gestureEvent( QskGestureEvent* event )
{
...
bool CoverflowSimple::gestureFilter( QQuickItem* item, QEvent* event )
{
...
QSizeF CoverflowSimple::coverSize( int index ) const
{
